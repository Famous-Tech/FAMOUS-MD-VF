...
famous({ nomCom: "appel", categorie: "Groupe", reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "lien", categorie: "Groupe", reaction: "🙋" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "nommer", categorie: "Groupe", reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "demettre", categorie: "Groupe", reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("Pour les groupe uniquement"); }
...
famous({ nomCom: "ajouter", categorie: 'Groupe', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
/** ***fin démettre****  **/
/** **retirer** */
famous({ nomCom: "retirer", categorie: "Groupe", reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, nomAuteurMessage, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("Pour les groupe uniquement"); }
...
famous({ nomCom: "supp", categorie: "Groupe",reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "info", categorie: "Groupe" }, async (dest, zk, commandeOptions) => {
 ...
 famous({ nomCom: "antilien", categorie: "Groupe", reaction: "🔗" }, async (dest, zk, commandeOptions) => {
 ...
 famous({ nomCom: "antibot", categorie: "Groupe", reaction: "🔗" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "groupe", categorie: "Groupe" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "bye", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "gnom", categorie: "Groupe" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "gdesc", categorie: "Groupe" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "gpp", categorie: "Groupe" }, async (dest, zk, commandeOptions) => {
...
/////////////
/* famous({nomCom:"annonce",categorie:"Groupe",reaction:"🎤"},async(dest,zk,commandeOptions)=>{
...
famous({ nomCom: "apk", reaction: "✨", categorie: "Recherche" }, async (dest, zk, commandeOptions) => {
