...
famous({ nomCom: "tgs", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "rejoindre", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
  ...
  famous({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "deblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
famous({ nomCom: "purge", categorie: "Groupe", reaction: "📣" }, async (dest, zk, commandeOptions) => {
